...
export default function ChatModal({ openChatModal, isOsDark, setIsOsDark }) {
  ...
  useEffect(() => {
    ...
    document.querySelector("html").dataset.theme = isOsDark
      ? "theme-dark"
      : "theme-light";
  }, [isOsDark]);
    ...
    return (
      <div className="message-bot-wrp">
        ...
        <div className="message-bot">
          I hope you are having fun browsing my site
        </div>
  ...
  const ChangeBotTheme = () => {
    return (
      <div className="message-bot-wrp">
        <div className="message-bot">
          You are lucky as you have dark and light theme options!
        </div>
    ...
    <div className="chat-modal-wrp">
      ...
      {!isContact && (
        <div className="chat-message clearfix" ref={scrollDiv}>
          ...
          {isSuggestion && (
            <div className="suggestions-wrp">
              <div className="suggestions" onClick={changeThemeHandler}>
                <span role="img" aria-label="theme">
                  🚀
                </span>{" "}
                &nbsp;&nbsp; Change the current theme
              </div>
              <div className="suggestions" onClick={sayHelloHandler}>
                <span role="img" aria-label="hi">
                  👋
                </span>{" "}
                &nbsp;&nbsp; I’d like to say hello!
              </div>
              <div className="suggestions" onClick={hireHandler}>
                <span role="img" aria-label="hire">
                  💼
                </span>{" "}
          ...
          {isHire && (
            <div className="suggestions-wrp">
              <div className="suggestions" onClick={() => setIsContact(true)}>
                <span role="img" aria-label="message">
                  💌{" "}
                </span>{" "}
                &nbsp;&nbsp; Send a message
              </div>
              <div className="suggestions" onClick={showSuggestion}>
