...
export default function ChatWithMe({ isOsDark, setIsOsDark }) {
  ...
  return (
    <React.Fragment>
      {!isChatOpen && (
        <div
          className={`chat-wrp ${!isChatOpen ? "" : "hide"}`}
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50.13 43.36">
            <g id="Layer_2" dataname="Layer 2">
              <g id="Layer_2-2" dataname="Layer 2">
                ...
                <path
                  className="cls-1"
                  d="M32.68,33.81a22.69,22.69,0,0,0,6.49-2.33"
                />
                <path
                  className="cls-1"
                ...
                <path
                  className="cls-1"
                  d="M13.72,39.52a17.64,17.64,0,0,1-5-1.81"
                />
